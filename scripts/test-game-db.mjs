...
export async function criarBancoTeste() {
  ...
  for (const arquivo of ['20260914100000_game.sql', '20260914100100_game_catalog.sql', '20260915120000_hearts_for_pairs.sql', '20260916100000_store.sql', '20260916210000_store_characters.sql']) {
